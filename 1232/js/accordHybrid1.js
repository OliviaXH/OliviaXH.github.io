...
module.sec2Pop = function(section) {
	...
	$("#pop_tab1").on("click", function() {
		...
		$(".sec2_pop .tab2").removeClass("hide").addClass("hide");
		$(".sec2_pop .tab3").removeClass("hide").addClass("hide");
		ga('send', 'event', '201609-accordsporthybrid', 'Technology-I', '具体位置',     {'dimension3': 'accord-sporthybrid', 'metric4': 1});
		//GA_008
		ga('send', 'event', '201609-accordsporthybrid', 'Technology-I', 'CVT',     {'dimension3': 'accord-sporthybrid', 'metric4': 1});
		console.log(2,'CVT')
		//GA_008 end
...
module.pop_close = function() {
	...
	//GA_006
	ga('send', 'event', '201609-accordsporthybrid', 'Index', 'video-'+GA_006_name, '视频时长'); 
	//GA_006 end
...
module.swiperVoice = function($dotIndex) {
 ...
 //hxm star
$main_a.text(maina_arr[currentIndex])
					 .attr('onclick',detail(currentIndex));
	}
	function detail(currentIndex)
	{
		ga('send', 'event', '201609-accordsporthybrid', 'Media', 'Article-'+currentIndex,     {'dimension3': 'accord-sporthybrid', 'metric7': 1}); 
